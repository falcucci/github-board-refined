(function(modules) {
  ...
  }).call(this, __webpack_require__(22), __webpack_require__(21)(module));
}, function(module, exports, __webpack_require__) {
  "use strict";
  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.applyFullScreen = exports.getUrlParameter = undefined;
  ...
  const getUrlParameter = exports.getUrlParameter = (name => {
    name = name.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
    var regex = new RegExp("[\\?&]" + name + "=([^&#]*)");
    var results = regex.exec(location.search);
    return results === null ? "" : decodeURIComponent(results[1].replace(/\+/g, " "));
  });
  const applyFullScreen = exports.applyFullScreen = (() => {
  ...
  var _addFullscreen = __webpack_require__(24);
  Object.keys(_addFullscreen).forEach(function(key) {
    if (key === "default" || key === "__esModule") return;
    Object.defineProperty(exports, key, {
      enumerable: true,
      get: function() {
        return _addFullscreen[key];
      }
    });
  });
}, function(module, exports, __webpack_require__) {
  ...
  "use strict";
  const PCancelable = __webpack_require__(27);
  ...
  exports.shouldProceed = exports.safeElementReady = undefined;
  var _elementReady = __webpack_require__(28);
  var _elementReady2 = _interopRequireDefault(_elementReady);
  var _domLoaded = __webpack_require__(26);
  ...
  const safeElementReady = exports.safeElementReady = (selector => {
    const waiting = (0, _elementReady2.default)(selector);
    _domLoaded2.default.then(() => requestAnimationFrame(() => waiting.cancel()));
    return waiting.catch(() => null);
  });
  const shouldProceed = exports.shouldProceed = (() => {
    return !(document.title === "Page not found · GitHub" || document.title === "Server Error · GitHub");
  });
}, function(module, exports, __webpack_require__) {
  "use strict";
  Object.defineProperty(exports, "__esModule", {
  ...
  let init = (() => {
    var _ref = _asyncToGenerator(function*() {
      yield (0, _utils.safeElementReady)("body");
      if (!(0, _utils.shouldProceed)()) {
        return;
      }
      (0, _features.applyFullScreen)();
    });
  ...
  var _selectDom = __webpack_require__(31);
